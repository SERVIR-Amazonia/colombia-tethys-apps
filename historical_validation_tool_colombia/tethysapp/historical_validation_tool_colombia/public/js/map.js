...
function IconMarker(rp) {
  const IconMarkerR = new L.Icon({
    iconUrl: `${server}/static/historical_validation_tool_colombia/images/icon_popup/${rp}.png`,
    shadowUrl: `${server}/static/historical_validation_tool_colombia/images/icon_popup/marker-shadow.png`,
    iconSize: [9, 14],
    iconAnchor: [5, 14],
    popupAnchor: [1, -14],
    shadowSize: [14, 14],
...
async function get_data_station(code, comid, name, river, basin, latitude, longitude, altitude, locality1, locality2, locality3){
    ...
    $("#station-basin-custom").html(`<b>ZONA HIDROGRÁFICA:</b> &nbsp ${basin.toUpperCase()}`)
...
function onEachFeature(feature, layer) {
    layer.bindPopup(
        "<div class='popup-container'>"+
            "<div class='popup-title'><b> DATOS DE LA ESTACIÓN </b></div>"+
               "<table style='font-size:12px'>"+
                "<tbody>"+
                    "<tr>"+
                        "<th class='popup-cell-title popup-cell'>CÓDIGO: </th>"+
                    ...
                    "</tr>"+
                    "<tr>"+
                        "<th class='popup-cell-title popup-cell'>RÍO: </th>"+
