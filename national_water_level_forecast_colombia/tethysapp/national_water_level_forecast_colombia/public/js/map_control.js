...
const loc_url = `${server}/static/national_water_level_forecast_colombia/geojson/dep/`;
...
const hyz_url = `${server}/static/national_water_level_forecast_colombia/geojson/hydr_zone/`;
...
const subhyz_url = `${server}/static/national_water_level_forecast_colombia/geojson/sub_hydr_zone/`;
